...
#define LAYER_ACTION_PLAY_AETHERON 5
#define LAYER_ACTION_PLAY_PIXEL 6

void layer_manager_render(uint16_t* framebuffer, bool menu_open, uint32_t time_ms, bool lore_menu_open);

/* When menu is open: touch handling. Returns LAYER_ACTION_* (craft 1, play cutscene 2, open lore 3, close lore 4, play Aetheron 5, play Pixel 6, else 0). */
